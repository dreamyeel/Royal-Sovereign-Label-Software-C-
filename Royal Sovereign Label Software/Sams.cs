...
namespace Royal_Sovereign_Label_Software
{
    public partial class Sams : Form
    {
        ...
        //    {
        //        MessageBox.Show("Please enter valid SO#");
        //        textBox1.Clear();
        //        textBox1.Focus();
        //    }
        //    else if (!int.TryParse(textBox1.Text, out numCheck))
        //    {
        ...
        //        return;
        //    int numCheck;
        //    if (textBox2.Text.Length > 7 || textBox2.Text.Length == 0)
        //    {
        //        MessageBox.Show("Please enter valid SO#");
        //        textBox2.Clear();
        //        textBox2.Focus();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if(radioButton1.Checked)
                printThread = new Thread(lm.PrintSamsCartonLabel);
            else
                printThread = new Thread(lm.PrintSamsPalletLabel);
        ...
        private void textBox1_EnterPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter)
                textBox2.Focus();
        }

        private void textBox2_EnterPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter)
                button1.Focus();
        }
